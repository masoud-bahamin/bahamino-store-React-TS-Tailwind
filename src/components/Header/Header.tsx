                ...
                <div className="flex justify-between items-center">
                    ...
                    <nav>
                        <div className="inline-flex" id="main_menu">
                            <ul className="flex flex-wrap p-1 md:p-2  text-sm md:text-base" id="menu_nav">
                                ...
                                <li className="relative mx-1 px-4 py-2 group  rounded-full mb-1 md:mb-0" id="button_pm">
                                    <NavLink to={"/cart"} className="font-semibold text-gray-600 hover:text-orange-300 flex gap-2 relative" >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                                        </svg>
                                        <span className=" absolute -top-4 -right-4 rounded-full px-1 bg-black text-white">{basketContext.basket?.length}</span>
                                        <div className="absolute top-7 right-0 bg-white w-96 p-5 rounded text-orange-300 hidden group-hover:block">
                                            {
