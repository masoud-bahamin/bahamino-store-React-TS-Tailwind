        ...
        <>
            ...
            <header className="bg-page border-b">
                <div className="container mx-auto px-4 sm:px-2 flex justify-between xl:gap-20 lg:gap-10 h-[84px] items-center">
                    <NavLink to={'/'}>
                        <img src="/img/logo.png" width={160} height={40} alt="" />
                    </NavLink>
                    ...
                    <div className={`${isShowMenu ? "top-0" : "-top-96"} lg:flex lg:gap-28 absolute lg:static z-10 transition-all duration-500 left-0 bg-white lg:bg-transparent items-center`}>
                    ...
                    <div className="flex items-center gap-3 justify-between h-11 text-xs ">
                        <div className="relative group rounded-full mb-1 md:mb-0" id="button_pm">
                            <NavLink to={"/cart"} className=" w-[120px] h-11 bg-white rounded-lg text-bold hover:text-primary flex items-center justify-center gap-2 relative" >
                        ...
                        <div className="relative group rounded-full mb-1 md:mb-0" >
                ...
                <nav className=" h-[75] bg-white flex items-center text-sm py-[14px] text-bold">
                    <div className="container mx-auto px-4 sm:px-2 inline-flex" id="main_menu">
