        ...
        <>
          <section className="bg-white py-8">
            <div className="container mx-auto flex items-center flex-wrap pt-4 pb-12">
              <nav id="store" className="w-full z-30 top-0 px-6 py-1 mb-6">
                <div className="w-full container mx-auto flex flex-wrap items-center  mt-0 px-2 py-3">
              ...
              <div className="w-full  p-6 flex gap-10  items-start">
                <div className="w-1/3">
                  <div className="w-full mb-5">
                    <img className="hover:grow hover:shadow-lg w-[400px] h-[400px]" src={imageSrc || product.thumbnail} />
                  </div>
