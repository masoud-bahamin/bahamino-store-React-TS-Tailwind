        ...
        <div>
                ...
                {loading ? (
                    ...
                    <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                        {data?.products?.map((product, i) => {
                            if (i < 4) return <AnimationDiv position={i % 2 === 0 ? "left" : "right"} key={product.id}><MainCard {...product} /></AnimationDiv>
                        })}
                    </div>
                )}
            ...
            <div className="container mx-auto px-4 sm:px-2 mb-12">
                ...
                {loading ? (
                    ...
                    <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5">
                        {data?.products?.map((product, i) => {
                            if (i < 8) return <AnimationDiv position={i % 2 === 0 ? "left" : "right"} key={product.id}><MainCard   {...product} /></AnimationDiv>
                        })}
                    </div>
                )}
